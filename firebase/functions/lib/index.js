...
exports.health = exports.onAuthUserDeleted = exports.onInquiryCreated = exports.trackActivityView = exports.setUserRole = void 0;
...
exports.trackActivityView = functions
    .region('europe-west1')
    .https.onCall(async (data, context) => {
    ...
    await ref.set({ viewCount: admin.firestore.FieldValue.increment(1), updatedAt: admin.firestore.FieldValue.serverTimestamp() }, { merge: true });
    return { ok: true };
});
exports.onInquiryCreated = functions
    .region('europe-west1')
